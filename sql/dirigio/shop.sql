...
*/
 ...
 SELECT id, name,custom_shop_id,ACTIVE,address FROM shops WHERE custom_shop_id IN (4617,4618,4619,4620,4621,4622,4606,4596,4593,4584,4605,4608,4615,4601,4602)

-- 閉店の場合はactive = 3にする
-- SELECT id, name,custom_shop_id,ACTIVE,address FROM shops WHERE custom_shop_id IN (1909,2776,2862,1872,4267)
